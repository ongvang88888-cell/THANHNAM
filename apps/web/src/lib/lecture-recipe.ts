...
export const RECIPE_CHECKLIST: RecipeRow[] = [
  ...
  { id: "avatar_presenter", status: "skipped", label: "Người dẫn ảo ghép góc bài", note: "Không tự chạy. Studio — HeyGen talking photo + overlay, cần khóa." },
  { id: "hailuo_character", status: "skipped", label: "Nhân vật 3D Hailuo ghép góc bài", note: "Không tự chạy. Cần MINIMAX_API_KEY." },
