...
export const RECIPE_CHECKLIST: RecipeRow[] = [
  ...
  { id: "toon_restyle", status: "applied", label: "Tô đậm người thành hoạt hình (trên máy)", note: "Tô đậm người giữa khung trên máy. Không đổi tóc/áo hay sinh nhân vật 3D kiểu Kling/Dreamina." },
  { id: "avatar_presenter", status: "skipped", label: "Người dẫn ảo thay người trong bài", note: "Không tự chạy. Studio — HeyGen talking photo che người gốc, cần khóa." },
  { id: "hailuo_character", status: "skipped", label: "Nhân vật 3D Hailuo thay người trong bài", note: "Không tự chạy. Che người gốc. Cần MINIMAX_API_KEY." },
