...
function resolveQuestionImage(topic: string, stem: string, explicit?: string): string | null {
  ...
  const signRules: Array<[RegExp, string]> = [
    ...
    [/cấm vượt|biển báo cấm vượt|\bp\.125\b/i, "/gplx/signs/P_125.svg"],
    [/cấm đỗ xe(?! ngày)|\bp\.131a\b/i, "/gplx/signs/P_131a.svg"],
    [/cấm dừng và đỗ|cấm dừng đỗ|\bp\.130\b/i, "/gplx/signs/P_130.svg"],
    [/hết biển hạn chế tốc độ|hết hạn chế tốc độ|\bp\.134\b/i, "/gplx/signs/P_134.svg"],
    ...
    [/cấm quay đầu|\bp\.120\b/i, "/gplx/signs/P_120.svg"],
    [/trẻ em|học sinh|\bw\.225\b/i, "/gplx/signs/W_225.svg"],
    ...
    [/hiệu lệnh đi thẳng|\br\.302/i, "/gplx/signs/R_302a.svg"],
    ...
    [/biển báo nguy hiểm thường|biển báo nguy hiểm giao nhau/i, "/gplx/signs/W_210.svg"],
    [/biển hiệu lệnh/i, "/gplx/signs/R_301a.svg"],
    [/biển chỉ dẫn|chỉ dẫn hướng đi/i, "/gplx/signs/I_401.svg"],
  ...
  if (
    ...
    const sitRules: Array<[RegExp, string]> = [
      ...
      [/cổng trường|tan học/i, "/gplx/situations/school-no-parking.svg"],
      [/trường học|học sinh|trẻ em/i, "/gplx/situations/school-zone.svg"],
      [/ra khỏi cao tốc/i, "/gplx/situations/highway-exit.svg"],
      [/làn dừng khẩn cấp|dừng khẩn cấp/i, "/gplx/situations/emergency-lane.svg"],
      [/nhập làn tăng tốc|nhập làn từ đường nhánh/i, "/gplx/situations/highway-merge.svg"],
      [/vạch vàng|vạch liền màu vàng|vượt qua vạch liền/i, "/gplx/situations/solid-yellow-line.svg"],
      [/vạch (trắng )?(nét )?đứt|vạch đứt màu trắng/i, "/gplx/situations/dashed-white-line.svg"],
      [/làn.*xe buýt|xe buýt/i, "/gplx/situations/bus-lane.svg"],
      [/mưa|đường trơn|ban đêm/i, "/gplx/situations/rain-wet-road.svg"],
      [/ngập/i, "/gplx/situations/flooded-road.svg"],
      [/đường hẹp|tránh xe ngược chiều/i, "/gplx/situations/narrow-road-yield.svg"],
      [/trên dốc|đỗ xe trên dốc|xuống dốc|lên dốc|đèo/i, "/gplx/situations/stop-on-slope.svg"],
      [/cấm dừng.*giao lộ|giao lộ.*cấm dừng|trên cầu|đường hầm/i, "/gplx/situations/no-stop-intersection.svg"],
      [/lùi xe|khi muốn lùi/i, "/gplx/situations/reverse-maneuver.svg"],
      [/chuyển làn|chuyển hướng/i, "/gplx/situations/lane-change.svg"],
      [/phanh gấp|khoảng cách an toàn/i, "/gplx/situations/sudden-brake.svg"],
      [/xe trước đang rẽ trái/i, "/gplx/situations/overtake.svg"],
      [/hiệu lệnh nào được ưu tiên/i, "/gplx/situations/intersection-uncontrolled.svg"],
      [/biển báo nguy hiểm giao nhau/i, "/gplx/signs/W_205a.svg"],
      [/biển báo chỉ dẫn hướng đi/i, "/gplx/signs/I_401.svg"],
      [/cao tốc/i, "/gplx/situations/highway-merge.svg"],
      [/vượt/i, "/gplx/situations/overtake.svg"],
      [/đường ưu tiên|đường nhánh/i, "/gplx/situations/priority-road.svg"],
