...
|--------|--------|-----------|-----|
| **Radar thị trường** | User lưu Ad Library + (sau này) feed có giấy phép | Intensity, Longevity, Velocity, Sales proxy, HeatScore **ước lượng** | Doanh thu / ROAS / CPA đối thủ |
...
HeatScore luôn hiển thị chú thích “ước lượng”. Sales proxy chỉ từ Shopee/TikTok/user nhập — không phải đơn Facebook.
