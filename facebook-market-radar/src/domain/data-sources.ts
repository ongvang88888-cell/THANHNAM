...
export const DATA_SOURCES: readonly DataSource[] = [
  ...
  },
  {
    ...
    vnCommercial: "yes",
    radarPort: "manual",
    ingestPath: "/api/collect + /api/theo-doi",
    provides: ["listingPriceVnd", "shopeeSold", "tiktokSold", "product watch"],
    missing: ["doanh số Facebook"],
    notesVi: "Proxy ngoài Facebook. Không crawl Shopee/TikTok. HeatScore vẫn ước lượng.",
  },
  {
